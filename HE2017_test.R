...
sim_HMM_WFM <- cmpsimulateHMM(model, missing, sel_cof, dom_par, pop_siz, int_gen, int_ale_frq, smp_gen, smp_chr_cnt)
...
sim_HMM_WFD <- cmpsimulateHMM(model, missing, sel_cof, dom_par, pop_siz, int_gen, int_ale_frq, smp_gen, smp_chr_cnt, ptn_num)
